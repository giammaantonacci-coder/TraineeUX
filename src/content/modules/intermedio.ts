    ...
    lessons: [
      {
        ...
        body: [
          ...
          "La parte che quasi nessuno fa bene è la severità. Un difetto pesa per tre cose: quanti utenti lo incontrano (frequenza), quanto li blocca (impatto), se dà fastidio ogni volta o ci si abitua (persistenza). Tre assi, non 'grave/non grave'.",
        ],
      ...
      },
      {
        ...
        body: [
          ...
          "— Legge di Fitts: il tempo per raggiungere un bersaglio dipende da distanza e dimensione. In pratica: i pulsanti pericolosi vanno lontani e piccoli, quelli frequenti vicini e grandi. Il bordo dello schermo conta come bersaglio enorme, perché il cursore ci si ferma contro.",
          "— Legge di Hick: il tempo per decidere cresce col logaritmo delle opzioni, non in modo lineare. Spezzare 12 voci in 3 menù da 4 non è automaticamente meglio: aggiunge passi. Conviene solo se il raggruppamento ha senso per l'utente.",
          ...
          "— Legge di Tesler: ogni processo ha una complessità che non si può eliminare. La domanda non è 'come la tolgo' ma 'chi se la prende: l'utente, il designer o l'ingegnere?'. Il design maturo la sposta sul sistema.",
    ...
    lessons: [
      {
        ...
        body: [
          ...
          "Gli schemi possibili sono pochi, e conviene sceglierli apposta: per argomento, per compito, per pubblico, per metafora, alfabetico, cronologico. Nei prodotti digitali funzionano quasi sempre per compito o per pubblico. Per argomento è il default pigro dei siti istituzionali.",
          "Attenzione all'ambiguità: molte cose stanno bene in più categorie. La soluzione non è trovare quella 'giusta' — non esiste — ma decidere se ammetti collocazioni multiple e dove sta la copia di riferimento.",
        ],
      ...
      },
      {
        ...
        body: [
          ...
          "Regola pratica per le faccette: mostra quanti risultati dà ogni valore; non lasciare combinazioni che portano a zero (o spiega subito come uscirne); tieni i filtri attivi visibili e rimuovibili uno per uno. Quasi tutti i filtri rotti sbagliano su questi tre punti.",
        ],
      },
    ],
    exercises: [
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        body: [
          "Un messaggio di errore ha tre compiti, in quest'ordine: dire cosa è successo, così che l'utente riconosca la situazione; dire cosa fare adesso; non far sentire stupido chi legge.",
